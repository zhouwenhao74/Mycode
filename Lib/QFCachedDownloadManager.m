...
static QFCachedDownloadManager *g_cachedDownloadManager = nil;


@implementation QFCachedDownloadManager
...
+ (QFCachedDownloadManager *)shareQFCachedDownloadManager
{
    ...
    {
        g_cachedDownloadManager = [[QFCachedDownloadManager alloc] init];
    }
