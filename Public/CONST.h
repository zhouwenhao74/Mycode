...
//搜索接口
#define Limit_SEARCH(str,page) [NSString stringWithFormat:@"http://1000phone.net:8088/app/iAppFree/api/limited.php?page=1&number=20&search=愤怒的小鸟"]
...
//分类限免费接口:
#define APPCATE_LIMIT(page) [NSString stringWithFormat:@"http://1000phone.net:8088/app/iAppFree/api/limited.php?page=%d&number=20&cate_id=",page]

//分类降价接口:
#define APPCATE_SALE(page) [NSString stringWithFormat:@"http://1000phone.net:8088/app/iAppFree/api/reduce.php?page=%d&number=20&cate_id=",page]
//分类免费接口:
#define APPCATE_FREE(page) [NSString stringWithFormat:@"http://1000phone.net:8088/app/iAppFree/api/free.php?page=%d&number=20&cate_id=",page]
//分类热榜接口:
#define APPCATE_HOT(page) [NSString stringWithFormat:@"http://1000phone.net:8088/app/iAppFree/api/hot.php?page=%d&number=20&cate_id=",page] 
#define APPINFORMATION_URL(appID) [NSString stringWithFormat:@"http://iappfree.candou.com:8080/free/applications/%@?currency=rmb",appID]
